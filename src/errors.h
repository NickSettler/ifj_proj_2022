...
#define SEMANTIC_FUNC_UNDEF_ERROR(...) ERROR(SEMANTIC_FUNC_UNDEF_ERROR_CODE, "[SEMANTIC UNDEF FUNC ERROR] " __VA_ARGS__)

#define SEMANTIC_FUNC_ARG_ERROR(...) ERROR(SEMANTIC_FUNC_ARG_ERROR_CODE, "[SEMANTIC FUNC ARG ERROR] " __VA_ARGS__)

#define SEMANTIC_UNDEF_VAR_ERROR(...) ERROR(SEMANTIC_UNDEF_VAR_ERROR_CODE, "[SEMANTIC UNDEF VAR ERROR] " __VA_ARGS__)

#define SEMANTIC_FUNC_RET_ERROR(...) ERROR(SEMANTIC_FUNC_RET_ERROR_CODE, "[SEMANTIC FUNC RET ERROR] " __VA_ARGS__)

#define SEMANTIC_TYPE_COMPAT_ERROR(...) ERROR(SEMANTIC_TYPE_COMPAT_ERROR_CODE, "[SEMANTIC TYPE COMPAT ERROR] " __VA_ARGS__)
